...
/***/ "./source/js/modules/helper.js":
/*!*************************************!*\
  !*** ./source/js/modules/helper.js ***!
  \*************************************/
/*! exports provided: animateDigits */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animateDigits", function() { return animateDigits; });
const animateDigits = (elem, initVal, lastVal, duration) => {
  const fps = 12;
  let startTime = null;
  let lastTime = null;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _animate_screen_change__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animate-screen-change */ "./source/js/modules/animate-screen-change.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  for (let i = 0; i < menuLinks.length; i++) {
    menuLinks[i].addEventListener(`click`, function (evt) {
      ...
      Object(_animate_screen_change__WEBPACK_IMPORTED_MODULE_0__["default"])(evt);
    });
  }
});
...
/***/ "./source/js/modules/prizes-svg.js":
/*!*****************************************!*\
  !*** ./source/js/modules/prizes-svg.js ***!
  \*****************************************/
/*! exports provided: initSVGAnimation, animatePrizesCount */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSVGAnimation", function() { return initSVGAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animatePrizesCount", function() { return animatePrizesCount; });
/* harmony import */ var _helper_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helper.js */ "./source/js/modules/helper.js");


const initSVGAnimation = function () {
...
const animatePrizesCount = () => {
  ...
  if (secondaryPrizeCountElem) {
    ...
    setTimeout(() => {
      Object(_helper_js__WEBPACK_IMPORTED_MODULE_0__["animateDigits"])(secondaryPrizeCountElem, initVal, 7, 500);
    }, secondaryPrizeDelay);
  }
  ...
  if (additionalPrizeCountElem) {
    ...
    setTimeout(() => {
      Object(_helper_js__WEBPACK_IMPORTED_MODULE_0__["animateDigits"])(additionalPrizeCountElem, initVal, 900, 600);
...
/***/ "./source/js/modules/results-svg.js":
/*!******************************************!*\
  !*** ./source/js/modules/results-svg.js ***!
  \******************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/screen-change-handler.js":
/*!****************************************************!*\
  !*** ./source/js/modules/screen-change-handler.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _prizes_svg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./prizes-svg */ "./source/js/modules/prizes-svg.js");
/* harmony import */ var _text_transform__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./text-transform */ "./source/js/modules/text-transform.js");
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./slider */ "./source/js/modules/slider.js");
/* harmony import */ var _game_timer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./game-timer */ "./source/js/modules/game-timer.js");





const timer = new _game_timer__WEBPACK_IMPORTED_MODULE_3__["default"]();
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  document.body.addEventListener(`screenChanged`, (evt) => {
    ...
    switch (evt.detail.screenName) {
      case `top`:
        Object(_text_transform__WEBPACK_IMPORTED_MODULE_1__["default"])(evt.detail.screenElement, `.intro__title`);
        Object(_text_transform__WEBPACK_IMPORTED_MODULE_1__["default"])(evt.detail.screenElement, `.intro__date`, 1200);
        break;
      case `story`:
        Object(_slider__WEBPACK_IMPORTED_MODULE_2__["default"])();
        Object(_text_transform__WEBPACK_IMPORTED_MODULE_1__["default"])(evt.detail.screenElement, `.slider__item-title`);
        break;
      case `prizes`:
        Object(_text_transform__WEBPACK_IMPORTED_MODULE_1__["default"])(evt.detail.screenElement, `.prizes__title`);

        if (!evt.detail.screenElement.classList.contains(`is-visited`)) {
          Object(_prizes_svg__WEBPACK_IMPORTED_MODULE_0__["initSVGAnimation"])();
          Object(_prizes_svg__WEBPACK_IMPORTED_MODULE_0__["animatePrizesCount"])();
        ...
        break;
      case `rules`:
        Object(_text_transform__WEBPACK_IMPORTED_MODULE_1__["default"])(evt.detail.screenElement, `.rules__title`);
        break;
      case `game`:
        timer.init();
        Object(_text_transform__WEBPACK_IMPORTED_MODULE_1__["default"])(evt.detail.screenElement, `.game__title`);
        break;
      default:
        break;
    }
...
/***/ "./source/js/modules/text-transform.js":
/*!*********************************************!*\
  !*** ./source/js/modules/text-transform.js ***!
  \*********************************************/
/*! exports provided: default */
...
class TextTransformAnimation {
  ...
  generateRandomDelayTime() {
    ...
    this._delay = Math.floor(Math.random() * (maxMS - minMS)) + (stepMS * this._stringNumber) + this._extraDelay;
  }
}

/* harmony default export */ __webpack_exports__["default"] = ((screenElement, className, delay) => {
  ...
  const textTransform = new TextTransformAnimation(textElement, delay);
  textTransform.init();
});
...
/* harmony import */ var _modules_screen_change_handler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/screen-change-handler */ "./source/js/modules/screen-change-handler.js");
...
/* harmony import */ var _modules_results_svg__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/results-svg */ "./source/js/modules/results-svg.js");
// modules
...
Object(_modules_screen_change_handler__WEBPACK_IMPORTED_MODULE_7__["default"])();
Object(_modules_results_svg__WEBPACK_IMPORTED_MODULE_9__["default"])();
